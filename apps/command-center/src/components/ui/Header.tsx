...
const tabs: { id: TabId; label: string; shortcut: string }[] = [
  ...
  { id: 'calendar', label: 'Calendar', shortcut: 'Ctrl+4' },
  { id: 'help', label: 'Help', shortcut: 'Ctrl+5' },
];
      ...
      <div className="flex items-center justify-between px-4 h-14">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <span className="text-base font-semibold text-zinc-100 font-display leading-none">Klarity</span>
            <span className="text-zinc-600 leading-none">|</span>
            <span className="text-[10px] text-zinc-400 font-medium tracking-wide leading-none uppercase translate-y-[1px]">Declutter. Design. Deploy.</span>
          </div>
        ...
        <nav className="flex items-center gap-1">
          {tabs.map((tab) => (
            <button
              ...
              className={clsx(
                'relative px-3 py-1.5 text-xs font-medium rounded-lg transition-all flex items-center gap-1.5',
                activeTab === tab.id
